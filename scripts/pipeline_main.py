...
from scripts.mock_generator import generate_mock_ticket_data_chunked
from scripts.address_normalizer import normalize_addresses
from scripts.data_hasher import apply_data_hashing
...
def main():
    ...
    parser.add_argument("--records", type=int, default=10000, help="생성할 모의 데이터 건수 (기본값: 10000)")
